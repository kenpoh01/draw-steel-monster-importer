...
After launching a world, it should appear under the "Add-on modules" tab. Launch your draw-steel world. Then, activate the module under "Game Settings" and "Manage Modules".
...
ALSO NOTE: Right now, for the Malice Parser, you have to put an \* between each ability to help the parser separate things properly. For the malice parser, only copy and paste the actual abilities, not the blurb at the top.
